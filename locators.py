...
class Locators:
    ...
    REGISTER_NAME = (By.XPATH, '//fieldset[1]/div/div/input') #инпут  ввода имени при регистрации
    REGISTER_EMAIL = (By.XPATH, '//fieldset[2]/div/div/input') #инпут ввода email при регистрации
    ...
    LOGIN_INPUT_EMAIL = (By.XPATH, '//fieldset[1]/div/div/input') # инпут ввода емейла для логина
    LOGIN_INPUT_PASSWORD = (By.XPATH, '//fieldset[2]/div/div/input') # инпут ввода пароля для логина
    ...
    SAUCES_BUTTON = (By.XPATH, '//main/section[1]/div[1]/div[2]') # вкладка "Соусы"
    TOPPING_BUTTON = (By.XPATH, '//main/section[1]/div[1]/div[3]') # вкладка "Начинки"
    BUNS_BUTTON = (By.XPATH, '//main/section[1]/div[1]/div[1]') # вкладка "Булки"
